...
Run commands from the project root, for example `D:\projects\coffee_multistress_memory`.
...
- The default project root in PowerShell scripts is `D:\projects\coffee_multistress_memory`; change `-ProjectRoot` if needed.
