...
Creates a reproducible project folder, downloads source metadata, supplementary files,
...
$dirs = @(
    ...
    "notebooks", "config", "env", "docs", "docs\literature", "docs\protocols", "logs"
)
...
Primary raw-read accessions listed by the source article:
...
# -----------------------------------------------------------------------------
# 2. Download supplementary material
# -----------------------------------------------------------------------------
