...
dir.create('results/paper_pack_v1/qc', recursive = TRUE, showWarnings = FALSE)
...
readr::write_tsv(qc, 'results/paper_pack_v1/qc/sample_qc_with_metadata.tsv')
readr::write_tsv(low, 'results/paper_pack_v1/qc/low_mapping_samples_lt50.tsv')
